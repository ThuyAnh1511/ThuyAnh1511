...
cred = credentials.Certificate(
    'iuh-20085651-firebase-adminsdk-xgllg-b356e71aa1.json')
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-20085651').stream())
    ...
    children=[
        html.Div(
            children=[
                ...
                html.H4(
                    "Trường: DHCN, Lớp: DHHTTT16B, MSSV: 20085651, Tên: PHẠM THÚY ANH", className="header-title"
                )
            ],
            className="header",
        ),
